...
def main(feature_set):
    ...
    trees_model = sklearn.ensemble.RandomForestClassifier(n_estimators=NESTIMATORS)
    ...
    grid_search = GridSearchCV(trees_model, search_parameters, cv=cv, verbose=VERBOSE_FLAG, n_jobs=NUMJOBS)
