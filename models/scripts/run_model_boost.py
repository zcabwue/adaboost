...
def main(feature_set):
    ...
    #specify the encoding method to read the csv
    ...
    trees_model = sklearn.ensemble.ExtraTreesClassifier(n_jobs=NUMJOBS, min_samples_leaf=3, max_depth=3, max_features=None,
    ...
    # Uncomment the following line to print relative feature importances.
    # the code which will be used to generate the appendix table 1 $ 2
    print(model.best_estimator_.feature_importances_)
    #write the result to a txt file
    # feature_importances = model.best_estimator_.feature_importances_
    #
    # # Specify the path to the text file where you want to save the feature importances
    # output_file_path = 'feature_importances.txt'
    #
    # # Write the feature importances to the specified text file
    # with open(output_file_path, 'w') as file:
    #     for importance in feature_importances:
    #         file.write(f"{importance}\n")
